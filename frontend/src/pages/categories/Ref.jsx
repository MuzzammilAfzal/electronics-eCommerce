    ...
    <div>
        ...
        <span className="font-extrabold text-2xl flex justify-center items-center w-full h-15">Single Door ️⬇️</span>
         ...
         <div className="w-full h-fit  p-2 my-2 rounded-2xl bg-[#a73453] ">
            ...
            <CategoriesCards title={"Godrej"} link={"/"} logic={{categories:"ref",section:"singledoor",brand:"godrej"}} limit={0} skip={0} />
            <CategoriesCards title={"Samsung"} link={"/"} logic={{categories:"ref",section:"singledoor",brand:"samsung"}} limit={0} skip={0} />
            <CategoriesCards title={"LG"} link={"/"} logic={{categories:"ref",section:"singledoor",brand:"lg"}} limit={0} skip={0} />
            <CategoriesCards title={"Whirlpool"} link={"/"} logic={{categories:"ref",section:"singledoor",brand:"whirlpool"}} limit={0} skip={0} />
         </div>
         ...
         <div className="w-full h-fit  p-2 my-2 rounded-2xl bg-[#2a2439] ">
            ...
            <CategoriesCards title={"Godrej"} link={"/"} logic={{categories:"ref",section:"doubledoor",brand:"godrej"}} limit={0} skip={0} />
            <CategoriesCards title={"Samsung"} link={"/"} logic={{categories:"ref",section:"doubledoor",brand:"samsung"}} limit={0} skip={0} />
            <CategoriesCards title={"LG"} link={"/"} logic={{categories:"ref",section:"doubledoor",brand:"lg"}} limit={0} skip={0} />
            <CategoriesCards title={"Whirlpool"} link={"/"} logic={{categories:"ref",section:"doubledoor",brand:"whirlpool"}} limit={0} skip={0} />
         </div>
    </div>
  )
}
